...
export const casinoData = [
  {
    ...
    rating: 4.8,
    description:
      "破壊力の高いスロットが多数揃う新進気鋭のオンラインカジノ。豪華ボーナスと高確率ジャックポットが魅力で、日本人プレイヤーからの支持も急増中。",
    officialLink:
      "https://record.discasinoaffiliates.com/_R757TaLb9LkdIqIeVhNpQ2Nd7ZgqdRLk/1/?pg=0",
...

  {
    ...
    rating: 4.8,
    description:
      "世界トップクラスの仮想通貨カジノ。高速出金・独自ゲーム・VIP待遇を備え、ビットコインユーザーから圧倒的な支持を獲得している。",
...

  {
    ...
    rating: 4.7,
    description:
      "ハイローラーから絶大な人気を得ているオンラインカジノ。旧式パチスロや高還元スロットが豊富で、ベットの自由度の高さも魅力。",
...

  {
    ...
    rating: 4.7,
    description:
      "仮想通貨に特化した次世代型カジノ。独自のクラッシュ系などのオリジナルゲームと、ユーザーに寄り添ったVIP特典が魅力。",
...

  {
    ...
    rating: 4.5,
    description:
      "日本人向けの設計が魅力のカジノ＆スポーツ総合プラットフォーム。多彩な決済方法や使いやすさが高評価。",
...

  {
    ...
    rating: 4.8,
    description:
      "初心者にも優しい日本語サポートと、安心の運営体制が魅力の高評価オンラインカジノ。登録ボーナスがあるため、初めての人にも人気。",
...

  {
    ...
    rating: 4.8,
    description:
      "世界最大級のブックメーカーとして有名。スポーツベットとカジノを同時に楽しめ、プロモコード『CALRO777』でお得に始められる。",
